...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mmrcis.Models.ExpenseBill", b =>
                {
                    ...
                    b.HasOne("mmrcis.Models.Person", "Patient")
                        .WithMany("ExpenseBillsAsPatient")
                        .HasForeignKey("PatientID")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("mmrcis.Models.IncomeBill", b =>
                {
                    b.HasOne("mmrcis.Models.Person", "Operator")
                        .WithMany("IncomeBillsAsOperator")
                        .HasForeignKey("OperatorID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("mmrcis.Models.Person", "Patient")
                        .WithMany("IncomeBillsAsPatient")
                        .HasForeignKey("PatientID")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("mmrcis.Models.PatientCheckinOut", b =>
                {
                    ...
                    b.HasOne("mmrcis.Models.Person", "Patient")
                        .WithMany("PatientCheckinOutsAsPatient")
                        .HasForeignKey("PatientID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("mmrcis.Models.Person", b =>
                {
                    ...
                    b.Navigation("ExpenseBillsAsPatient");

                    b.Navigation("IncomeBillsAsOperator");

                    b.Navigation("IncomeBillsAsPatient");

                    b.Navigation("PatientCheckinOutsAsDoctor");

                    b.Navigation("PatientCheckinOutsAsPatient");
