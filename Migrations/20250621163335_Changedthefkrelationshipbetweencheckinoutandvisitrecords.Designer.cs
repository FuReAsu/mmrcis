...
namespace mmrcis.Migrations
{
    ...
    [Migration("20250621163335_Changedthefkrelationshipbetweencheckinoutandvisitrecords")]
    partial class Changedthefkrelationshipbetweencheckinoutandvisitrecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mmrcis.Models.IncomeBill", b =>
                {
                    ...
                    b.Property<int?>("PatientCheckInOutID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PatientCheckInOutID")
                        .IsUnique()
                        .HasFilter("[PatientCheckInOutID] IS NOT NULL");
            ...
            modelBuilder.Entity("mmrcis.Models.PatientVitals", b =>
                {
                    ...
                    b.Property<int>("PatientVisitRecordID")
                        .HasColumnType("int");

                    b.Property<decimal>("PulseRate")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("RespiratorRate")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("mmrcis.Models.IncomeBill", b =>
                {
                    b.HasOne("mmrcis.Models.PatientCheckInOut", "PatientCheckInOut")
                        .WithOne("IncomeBill")
                        .HasForeignKey("mmrcis.Models.IncomeBill", "PatientCheckInOutID")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("PatientCheckInOut");
            ...
            modelBuilder.Entity("mmrcis.Models.PatientVisitRecord", b =>
                {
                    b.HasOne("mmrcis.Models.Person", "Doctor")
                        .WithMany("PatientVisitRecordAsReceivedByDoctor")
            ...
            modelBuilder.Entity("mmrcis.Models.PatientVitals", b =>
                {
                    b.HasOne("mmrcis.Models.Person", "MedicalStaff")
                        .WithMany("PatientVitalsAsMedicalStaff")
                        .HasForeignKey("MedicalStaffID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("mmrcis.Models.PatientVisitRecord", "PatientVisitRecord")
                        .WithOne("PatientVitals")
                        .HasForeignKey("mmrcis.Models.PatientVitals", "PatientVisitRecordID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MedicalStaff");

                    b.Navigation("PatientVisitRecord");
                });
            ...
            modelBuilder.Entity("mmrcis.Models.Person", b =>
                {
                    ...
                    b.Navigation("PatientVisitRecordAsReceivedByDoctor");

                    b.Navigation("PatientVitalsAsMedicalStaff");
                });
